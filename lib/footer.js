...
function footerHtml() {
  ...
  <div class="container footer-grid">
    <div class="footer-col">
      <a class="footer-logo" href="/" data-i18n-skip aria-label="Entre Olas Surf"><img src="/images/logo.png" alt="Entre Olas Surf — Escuela de surf en Roche" class="footer-logo-img" width="120" height="120" loading="lazy"></a>
      <p class="footer-tagline">Escuela de surf en Roche. Clases para todos los niveles acompañadas del tiempo y la naturaleza de la costa de Cádiz.</p>
    </div>
    <div class="footer-col">
      <h4>Navegar</h4>
