...
async function init() {
  const { data: camps, error } = await supabase
    .from('surf_camps')
    .select('slug, title, kicker, hero_kicker, description, whats_included, sold_out, spots_taken, max_spots, price, original_price, deposit, status, hero_image, date_start, date_end')
    .order('date_start');
