/* ============================================================
   ...
   La card solo muestra el producto y enlaza a /producto/?slug=…
   La compra (color, talla, añadir) se hace dentro de la ficha.
   ============================================================ */
...
// ---- Render product card (link a la ficha) ----
function renderCard(product) {
  ...
  return `
    <a class="shop-card${isOutOfStock ? ' shop-card--sold-out' : ''}" href="${href}" data-category="${product.category || ''}">
      ...
      <div class="shop-card-body">
        ...
        <div class="shop-card-footer">
          ...
          <span class="shop-card-view">Ver producto →</span>
        </div>
      </div>
    </a>`;
}
